...
/*
func DefaultScrape(doc *goquery.Document) (rows [][]string, err error) {
	doc.Find("#screener-content").Find("tbody").Eq(3).Each(func(i int, childNode *goquery.Selection) {
...
func ChartScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var headers []string
	...
	return utils.GenerateRows(headers, tickerDataSlice)
}

func BasicScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var headers []string
...
func NewsScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var headers []string
	var rawTickerData map[string]interface{}
...
func DescriptionScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var headers []string
	var rawTickerData map[string]interface{}
...
func SnapshotScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var headers []string
	var rawTickerData map[string]interface{}
...
func TAScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var headers []string
...
func TickerScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickerDataSlice []map[string]interface{}
	var rawTickerData map[string]interface{}
...
func BulkScrape(doc *goquery.Document) (rows [][]string, err error) {
	...
	headers := []string{"Ticker", "Change", "Chart", "Company", "Industry", "Country", "Market Cap"}
	return utils.GenerateRows(headers, tickers)
}

func BulkFullScrape(doc *goquery.Document) (rows [][]string, err error) {
	var tickers []map[string]interface{}
	var tickerDataSlice [][]map[string]interface{}
	var rawTickerData map[string]interface{}
	rootNode := doc.Find("#screener-content").Find("tbody").Eq(3).Find("tr")
